    ...
    <ul class="navbar-nav ms-auto align-items-center">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-bs-toggle="dropdown">
                <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" width="30" class="rounded-circle me-2">
                <span>Admin</span>
            </a>
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="laporan_masuk.php">Laporan Barang Masuk</a>
                    <a class="nav-link" href="laporan_keluar.php">Laporan Barang Keluar</a>
                </div>
            </div>
        </nav>
    </div>
